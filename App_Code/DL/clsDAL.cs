...
public class clsDAL : IDisposable
{
    ...
    public static DataSet FillDataSet(string strProcedureName)
    {
        try
        {
            if (OpenConnection())
            {
                _sqlCmd = new MySqlCommand(strProcedureName, _connection);
    ...
    public static string AuthenticateUser(string strProcedure, string Username, string Password, string msg)
    {
        try
        {
            if (OpenConnection())
            {
                _sqlCmd = new MySqlCommand(strProcedure, _connection);
                _sqlCmd.CommandType = CommandType.StoredProcedure;
                ...
                MySqlDataReader rdr = _sqlCmd.ExecuteReader();
                while (rdr.Read())
                {
    ...
    public String Get_Single_FieldValue_fromDR(string strSQlQuery)
    {
        ...
        try
        {
            ...
            if (OpenConnection())
            {
                _sqlCmd = new MySqlCommand(strSQlQuery, _connection);
    ...
    {
        MySqlCommand[] sqlCommand = new MySqlCommand[strProcedureName.Length];
        try
        {
            if (OpenConnection())
            {
                ...
                for (int i = 0; i < strProcedureName.Length; i++)
                {
                    ...
                    {
                        sqlCommand[i] = new MySqlCommand(strProcedureName[i], _connection);
        ...
        if (OpenConnection())
        {
            ...
            try
            {
                for (int i = 0; i < tableList.Count; i++)
                {
                    ...
                    _sqlCmd = new MySqlCommand(strProc, _connection);
    ...
    public static string ExecuteDelete(string query)
    {
        try
        {
            if (OpenConnection())
            {
                _sqlCmd = new MySqlCommand(query, _connection);
    ...
    public static string ExecuteSP(string TableName, string ColumnName, int OldAcCode, int NewAcCode, string WhereCondition)
    {
        ...
        try
        {
            if (OpenConnection())
            {
                _sqlCmd = new MySqlCommand("spClubAccount", _connection);
                _sqlCmd.Transaction = _transaction;
                _sqlCmd.CommandType = CommandType.StoredProcedure;
    ...
    public static void ExecuteMergedAccountsSP(string RightAccountCode, string WrongAccountCode, string Created_By, string RightAccountFilePath, string WrongAccountFilePath, string Company_Code, string Year_Code)
    {
        try
        {
            if (OpenConnection())
            {
                _sqlCmd = new MySqlCommand("spInsertMergedAccount", _connection);
                _sqlCmd.Transaction = _transaction;
                _sqlCmd.CommandType = CommandType.StoredProcedure;
    ...
    public static int Read(string qry)
    {
        ...
        try
        {
            ...
            _sqlCmd = new MySqlCommand(_Query, _connection, _transaction);
            _sqlCmd.ExecuteNonQuery();
            Thread.Sleep(100);
            _transaction.Commit();
            Message = 1;
    ...
    public static MySqlDataReader ReadData(string str)
    {
        try
        {
            if (OpenConnection())
    ...
    //                _sqlCmd = new MySqlCommand(Head_Insert, _connection, _transaction);
    //                _sqlCmd.ExecuteNonQuery();
    //                _sqlCmd = new MySqlCommand(Detail_Insert, _connection, _transaction);
    //                _sqlCmd.ExecuteNonQuery();
    //                _transaction.Commit();
    //                Msg = "Insert";
        ...
        try
        {
            if (OpenConnection())
            {
                ...
                if (flag == 1)
                {
                    ...
                    {
                        _sqlCmd = new MySqlCommand(GLEDGER_Delete, _connection, _transaction);
                        _sqlCmd.ExecuteNonQuery();
                    }
                    ...
                    {
                        _sqlCmd = new MySqlCommand(GLEDGER_Insert, _connection, _transaction);
                        _sqlCmd.ExecuteNonQuery();
                    }
                    _transaction.Commit();
                    msg = "Insert";
                ...
                else if (flag == 2)
                {
                    ...
                    if (Detail_Delete != "")
                    {
                        _sqlCmd = new MySqlCommand(Detail_Delete, _connection, _transaction);
                        _sqlCmd.ExecuteNonQuery();
                    }
                    if (Detail_Insert != "")
                    {
                    ...
                    if (Head_Update != "")
                    {
                        _sqlCmd = new MySqlCommand(Head_Update, _connection, _transaction);
                        _sqlCmd.ExecuteNonQuery();
                    }
                    if (Detail_Update != "")
                    {
                        _sqlCmd = new MySqlCommand(Detail_Update, _connection, _transaction);
                        _sqlCmd.ExecuteNonQuery();
                    }
                ...
                else
                {
                    ...
                    _sqlCmd = new MySqlCommand(Head_Delete, _connection, _transaction);
                    _sqlCmd.ExecuteNonQuery();
    ...
    public static int AccountID(string Ac_Code, int Company_Code)
    {
        ...
        try
        {
            ...
            if (OpenConnection())
            {
                _sqlCmd = new MySqlCommand("Sp_AccountMaster", _connection);
                _sqlCmd.CommandType = CommandType.StoredProcedure;
