...
public class clsLocalVoucher
{
    ...
    public static string strConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionString1"].ConnectionString;
    public static MySqlConnection _connection = new MySqlConnection();
    private static MySqlDataReader _reader = null;

    private static MySqlDataAdapter _adapter = null;
    private static MySqlCommand _sqlCmd = null;
    ...
    public static DataTable LV_Posting(int flag, LocalVoucher LV, string Type)
    {
        ...
        try
        {
            ...
            else if (flag == 3)
            {
                ...
                returndt.Rows.Add(dr);
                //GLEDGER_Delete = "delete from nt_1_gledger where TRAN_TYPE='LN' and Doc_No=" + LV.LV_Doc_No + " and COMPANY_CODE=" + LV.LV_Company_Code + " and Year_Code=" + LV.LV_Year_Code + "";
            ...
            if (flag == 1 || flag == 2)
            {
                ...
                string QualityAC_Id = clsCommon.getString("select ifnull(accoid,0) as accoid from qrymstaccountmaster where Ac_Code=" + Quality_Diff_Ac + " and Company_Code=" + LV.LV_Company_Code + " ");
                string CGSTAC_Id = clsCommon.getString("select ifnull(accoid,0) as accoid from qrymstaccountmaster where Ac_Code=" + CGSTAc + " and Company_Code=" + LV.LV_Company_Code + " ");
                string SGSTAC_Id = clsCommon.getString("select ifnull(accoid,0) as accoid from qrymstaccountmaster where Ac_Code=" + SGSTAc + " and Company_Code=" + LV.LV_Company_Code + " ");
                string IGSTAC_Id = clsCommon.getString("select ifnull(accoid,0) as accoid from qrymstaccountmaster where Ac_Code=" + IGSTAc + " and Company_Code=" + LV.LV_Company_Code + " ");


                string PurchaseCGST_Id = clsCommon.getString("select ifnull(accoid,0) as accoid from qrymstaccountmaster where Ac_Code=" + PurchaseCGST + " and Company_Code=" + LV.LV_Company_Code + " ");
                string PurchaseSGST_Id = clsCommon.getString("select ifnull(accoid,0) as accoid from qrymstaccountmaster where Ac_Code=" + PurchaseSGST + " and Company_Code=" + LV.LV_Company_Code + " ");
                string PurchaseIGST_Id = clsCommon.getString("select ifnull(accoid,0) as accoid from qrymstaccountmaster where Ac_Code=" + PurchaseIGST + " and Company_Code=" + LV.LV_Company_Code + " ");
                string POSTAGEAc_Id = clsCommon.getString("select ifnull(accoid,0) as accoid from qrymstaccountmaster where Ac_Code=" + POSTAGE_AC + " and Company_Code=" + LV.LV_Company_Code + " ");
                string ResaleAc_id = clsCommon.getString("select ifnull(accoid,0) as accoid from qrymstaccountmaster where Ac_Code=" + Resale_comm_Ac + " and Company_Code=" + LV.LV_Company_Code + " ");
                string OTHERAmount_Id = clsCommon.getString("select ifnull(accoid,0) as accoid from qrymstaccountmaster where Ac_Code=" + OTHER_AMOUNT_AC + " and Company_Code=" + LV.LV_Company_Code + " ");
                string Ac_id = clsCommon.getString("select ifnull(accoid,0) as accoid from qrymstaccountmaster where Ac_Code=" + LV.LV_Ac_Code + " and Company_Code=" + LV.LV_Company_Code + " ");
                string Transport_id = clsCommon.getString("select ifnull(accoid,0) as accoid from qrymstaccountmaster where Ac_Code=" + LV.LV_Transport_Code + " and Company_Code=" + LV.LV_Company_Code + " ");
