    ...
    public static DataTable Sale_Posting(int flag, SaleFields sale, string type, DataTable dt)
    {
        ...
        try
        {
            ...
            if (flag == 1)
            {
                ...
                SaleDetailId = Convert.ToInt32(clsCommon.getString("SELECT ifnull(count(saledetailid),0) as saledetailid from nt_1_sugarsaledetails"));
                if (SaleDetailId == 0)
                {
                    SaleDetailId = 0;
                }
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    try
                    {
                        ic = Convert.ToInt32(clsCommon.getString("select ifnull(systemid,0) as id from nt_1_systemmaster where Company_Code='" + sale.SB_Company_Code + "' " +
            ...
            else if (flag == 2)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    try
                    {
                        ic = Convert.ToInt32(clsCommon.getString("select ifnull(systemid,0) as id from nt_1_systemmaster where System_Code=" + item_code + "  and Company_Code=" + sale.SB_Company_Code + " and System_Type='I'"));
                    }
                    catch
                    {
                    }
            ...
            if (flag == 1 || flag == 2)
            {
                ...
                string Acid = clsCommon.getString("select ifnull(accoid,0) as id from qrymstaccountmaster where  Ac_Code=" + sale.SB_Ac_Code + " and Company_Code=" + sale.SB_Company_Code + "");
                string unitid = clsCommon.getString("select ifnull(accoid,0) as id from qrymstaccountmaster where  Ac_Code=" + sale.SB_Unit_Code + " and Company_Code=" + sale.SB_Company_Code + "");
                string transportid = clsCommon.getString("select ifnull(accoid,0) as id from qrymstaccountmaster where  Ac_Code=" + sale.SB_TRANSPORT_CODE + " and Company_Code=" + sale.SB_Company_Code + "");
                string millid = clsCommon.getString("select ifnull(accoid,0) as id from qrymstaccountmaster where  Ac_Code=" + sale.SB_mill_code + " and Company_Code=" + sale.SB_Company_Code + "");
                string itemid = clsCommon.getString("select ifnull(accoid,0) as sysid from qrymstaccountmaster where  Ac_Code=" + SaleAcc + " and Company_Code=" + sale.SB_Company_Code + "");
                string SaleCGST_id = clsCommon.getString("select ifnull(accoid,0) as id from qrymstaccountmaster where  Ac_Code=" + SaleCGST + " and Company_Code=" + sale.SB_Company_Code + "");
                string SaleSGST_id = clsCommon.getString("select ifnull(accoid,0) as id from qrymstaccountmaster where  Ac_Code=" + SaleSGST + " and Company_Code=" + sale.SB_Company_Code + "");
                string SaleIGST_id = clsCommon.getString("select ifnull(accoid,0) as id from qrymstaccountmaster where  Ac_Code=" + SaleIGST + " and Company_Code=" + sale.SB_Company_Code + "");
                ...
                string roundoffac = clsCommon.getString("select RoundOff from nt_1_companyparameters where Company_Code=" + sale.SB_Company_Code +
                    " and Year_Code=" + sale.SB_Year_Code + "");
                string roundoff_id = clsCommon.getString("select ifnull(accoid,0) as id from qrymstaccountmaster where  Ac_Code=" + roundoffac + " and Company_Code=" + sale.SB_Company_Code + "");
