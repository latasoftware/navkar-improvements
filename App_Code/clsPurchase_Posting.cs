    ...
    public static DataTable Purchase_Posting(int flag, PurchaseFields purchase, string Type, DataTable dt)
    {
        ...
        try
        {
            ...
            if (flag == 1)
            {
                ...
                PurchaseDetailId = Convert.ToInt32(clsCommon.getString("SELECT ifnull(count(purchasedetailid),0) as purchasedetailid from nt_1_sugarpurchasedetails"));
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    try
                    {
                        ic = Convert.ToInt32(clsCommon.getString("select ifnull(systemid,0) as id from nt_1_systemmaster where Company_Code='" + purchase.PS_Company_Code + "' " +
            ...
            else if (flag == 2)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    try
                    {
                        ic = Convert.ToInt32(clsCommon.getString("select ifnull(systemid,0) as id from nt_1_systemmaster where System_Code=" + item_code + "  and Company_Code=" + purchase.PS_Company_Code + " and System_Type='I'"));
                    }
                    catch
                    {
            ...
            if (flag == 1 || flag == 2)
            {
                ...
                string acid = clsCommon.getString("select ifnull(accoid,0) as id from qrymstaccountmaster where  Ac_Code=" + purchase.PS_Ac_Code + " and Company_Code=" + purchase.PS_Company_Code + "");
                string millid = clsCommon.getString("select ifnull(accoid,0) as id from qrymstaccountmaster where  Ac_Code=" + purchase.PS_mill_code + " and Company_Code=" + purchase.PS_Company_Code + "");
                string itemid = clsCommon.getString("select ifnull(accoid,0) as sysid from qrymstaccountmaster where  Ac_Code=" + PurchaseAcc + " and Company_Code=" + purchase.PS_Company_Code + "");
                string PurchaseCGST_id = clsCommon.getString("select ifnull(accoid,0) as id from qrymstaccountmaster where  Ac_Code=" + PurchaseCGST + " and Company_Code=" + purchase.PS_Company_Code + "");
                string PurchaseSGST_id = clsCommon.getString("select ifnull(accoid,0) as id from qrymstaccountmaster where  Ac_Code=" + PurchaseSGST + " and Company_Code=" + purchase.PS_Company_Code + "");
                string PurchaseIGST_id = clsCommon.getString("select ifnull(accoid,0) as id from qrymstaccountmaster where  Ac_Code=" + PurchaseIGST + " and Company_Code=" + purchase.PS_Company_Code + "");
