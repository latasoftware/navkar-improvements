                        ...
                        if (ds != null)
                        {
                            if (ds.Tables.Count > 0)
                            {
                                ...
                                if (dt.Rows.Count > 0)
                                {
                                    ...
                                    //Session["VASULI_AC"] = dt.Rows[0]["VASULI_AC"].ToString();
                                    ...
                                    Session["freightac_id"] = clsCommon.getString("select accoid from qrymstaccountmaster where Ac_Code=" + Session["Freight_Ac"].ToString() + " and Company_Code=" + Session["Company_Code"].ToString() + "");
                                }
                            }
                        }
                        #endregion
