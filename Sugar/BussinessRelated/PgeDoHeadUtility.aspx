<%@ Page Language="C#" Title="DO Utility" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="PgeDoHeadUtility.aspx.cs" Inherits="Sugar_Master_PgeDoHeadUtility" %>
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(16).html($(this).find("doid").text());
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div id="popup" style="max-height: 600px; overflow-y: scroll;">
                ...
                <center>
                    &nbsp;
            <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1700px" Height="60"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderStyle-Width="10" DataField="purc_order" HeaderText="TenderDetail ID" />
                    ...
                    <asp:BoundField HeaderStyle-Width="20px" DataField="Tender_Commission" HeaderText="Commission    " />
                    ...
                    <asp:BoundField HeaderStyle-Width="30px" DataField="EWay_Bill_No" HeaderText="EwayBill_No" />
