        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table width="100%" style="margin-left: 60px;" align="left" cellpadding="5" cellspacing="6">
                    ...
                    <tr>
                        <td align="left">
                            <asp:Button Text="Delivery SMS" runat="server" ID="btnDeliverySms" Width="110px"
                                Height="24px" CssClass="btnHelp" OnClick="btnDeliverySms_Click" />
                            &nbsp;
                            <asp:Button Text="New Partywise 1" runat="server" ID="btnNewPartyWise" Width="120px"
                                Height="24px" CssClass="btnHelp" OnClick="btnNewPartyWise_Click" />
                            &nbsp;
                            <asp:Button Text="New Partywise 2" runat="server" ID="btnNewPartywise2" Width="120px"
                                Height="24px" CssClass="btnHelp" OnClick="btnNewPartywise2_Click" />
                            &nbsp;
                            <asp:Button Text="Mill Payment" runat="server" ID="btnMillPayment" Width="120px"
                            ...
                            <asp:Button Text="Mill Payment For GST" runat="server" ID="btnMillPaymentForGST"
                                Width="150px" Height="24px" CssClass="btnHelp" OnClick="btnMillPaymentForGST_Click" />
                            <asp:Button Text="Only DO" runat="server" ID="btndo" Width="150px"
