...
public partial class Report_pgeRegisters : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
     ...
     " dbo.NT_1_AccountMaster.Company_Code = dbo.NT_1_CityMaster.company_code  WHERE (Ac_Code like '%" + txtSearchText.Text + "%' or Ac_Name_E like '%" + txtSearchText.Text + "%' or Short_Name like '%" + txtSearchText.Text + "%' or city_name_e like '%" + txtSearchText.Text + "%') and (dbo.NT_1_AccountMaster.Ac_type = 'M') and  dbo.NT_1_AccountMaster.Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " ORDER BY dbo.NT_1_AccountMaster.Ac_Name_E";
                ...
                //string qry = "SELECT     TOP (100) PERCENT dbo.NT_1_AccountMaster.Ac_Code as Account Code, dbo.NT_1_AccountMaster.Ac_Name_E as Account Name, dbo.NT_1_AccountMaster.Short_Name as Short Name, dbo.NT_1_CityMaster.city_name_e as City_Name " +
                ...
                //        " WHERE (Ac_Code like '%" + txtSearchText.Text + "%' or Ac_Name_E like '%" + txtSearchText.Text + "%' or Short_Name like '%" + txtSearchText.Text + "%' or City_Name like '%" + txtSearchText.Text + "%') and (dbo.NT_1_AccountMaster.Ac_type = 'M') and  Company_Code='" + Convert.ToInt32(Session["Company_Code"].ToString()) + "' ORDER BY dbo.NT_1_AccountMaster.Ac_Name_E";
                this.showPopup(qry);
            }
        }
        catch
