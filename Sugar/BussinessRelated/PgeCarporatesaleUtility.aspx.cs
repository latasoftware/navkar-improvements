...
public partial class Sugar_Master_PgeCarporatesaleUtility : System.Web.UI.Page
{
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, int PageSize, int Company_Code)
    {
        ...
        foreach (var s in split)
        {
            ...
            name += "( carporatepartyaccountname like '%" + aa + "%' or carporatepartyunitname like '%" + aa + "%' or carporatepartybrokername like '%" + aa + "%' or doc_no like '%" + aa + "%' or doc_dateConverted like '%" + aa + "%' or pono like '%" + aa + "%' or quantal like '%" + aa + "%' or sell_rate like '%" + aa + "%' or carpid like '%" + aa + "%' or remark like '%" + aa + "%') and";
       ...
       + "carporatepartyaccountname ,carporatepartyunitname,carporatepartybrokername,pono,quantal,sell_rate, remark,carpid FROM qrycarporatehead   where " + name + " and Company_Code=" + Company_Code + " " +
