<%@ Page Language="C#" Title="Tender Utility" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="PgeTenderHeadUtility.aspx.cs" Inherits="Sugar_Master_PgeTenderHeadUtility" %>
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(8).html($(this).find("tenderid").text());
