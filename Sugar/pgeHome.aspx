    ...
    <div class="leftPane" style="width: 1300px; height: 30px; margin: 20px 0 0 0px;">
        <table width="100%" cellpadding="2" cellspacing="10">
            ...
            <tr>
                ...
                <td>
                    <a href="../Report/rptSugarBalanceStocks.aspx" target="_blank" style="font-size: large; text-decoration: none; color: White; width: 170px;"
                        class="button">
                        <p style="margin: 20px auto; margin-left: 10px;">
                            Stock Book
                        </p>
            ...
            <tr>
                ...
                <td>
                    <asp:Button runat="server" ID="btndatabasebackup" Text="Database Backup" Style="font-size: large; text-decoration: none; color: White; width: 190px; height: 80px;"
                        class="button"
                    ...
                    <ul class="social-media-list">
                        <li>
                            <a target="_blank" href="https://services.gst.gov.in/services/login">
                                <img src="../Images/gst.png" height="40px" width="40px" />
                            </a>
