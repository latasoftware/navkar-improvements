<%@ Page Language="C#" Title="LV Utility" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="PgeLocalVoucherUtility.aspx.cs" Inherits="Sugar_Master_PgeLocalVoucherUtility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
            ...
            $('#gvCustomers ').on('dblclick', 'tr', function () {
                ...
                if (row_index > 0) {
                    if (isNaN(Ac_Code)) {
                        ...
                        window.open('../Outword/pgeLocalVoucherForGSTxmlNew.aspx?commissionid=' + Ac_Code + '&Action=' + Action);
                    }
                }
            });
    ...
    <script type="text/javascript">
        function LocalVoucher() {
            ...
            window.open('../Outword/pgeLocalVoucherForGSTxmlNew.aspx?doc_no=' + Ac_Code + '&Action=' + Action);
        }
    </script>
</asp:Content>
