<%@ Page Title="Local Voucher" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgeLocalVoucherForGSTxmlNew.aspx.cs" Inherits="Sugar_pgeLocalVoucherForGSTxml" %>
                    ...
                    <table width="80%" align="left">
                        <tr>
                            ...
                            <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="btnHelp" Width="90px"
                                TabIndex="33" Height="24px" ValidationGroup="save" OnClick="btnEdit_Click" />
                                &nbsp;
                            ...
                            <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btnHelp" Width="90px"
                                TabIndex="35" Height="24px" ValidationGroup="save" OnClick="btnCancel_Click" />
                                &nbsp;&nbsp;
                        <asp:Button ID="btnBack" runat="server" Text="Back" CssClass="btnHelp" Width="90px"
                            ValidationGroup="save" Height="24px" OnClientClick="Back();" />
                                &nbsp;<asp:Button ID="btnPrint" runat="server" Text="Print" CssClass="btnHelp" Width="90px"
                                    TabIndex="36" Height="24px" OnClick="btnPrint_Click" />
                            </td>
                    ...
                    <table style="width: 80%;" align="left" cellpadding="2" cellspacing="5">
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="6" style="width: 10%;">
                                ...
                                &emsp;&emsp;&emsp;
                                Transport: &nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtTRANSPORT_CODE" runat="Server" CssClass="txt" TabIndex="12" Width="80px"
                                    onkeydown="Transport(event);" Style="text-align: right;" AutoPostBack="false" OnTextChanged="txtTRANSPORT_CODE_TextChanged"
                                    Height="24px"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="3" style="width: 10%;">
                                <asp:TextBox ID="txtMILL_CODE" runat="Server" CssClass="txt" TabIndex="13" Width="90px"
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="6" style="width: 10%;">
                                <asp:TextBox ID="txtMILL_RATE" runat="Server" CssClass="txt" TabIndex="14" Width="110px"
                                ...
                                <asp:TextBox ID="txtSALE_RATE" runat="Server" CssClass="txt" TabIndex="15" Width="80px"
                                ...
                                &nbsp; Purc Rate: &nbsp;
                                <asp:TextBox ID="txtPURCHASE_RATE" runat="Server" CssClass="txt" TabIndex="16" Width="80px"
                                ...
                                &nbsp; GST Rate Code  &emsp;
                                <asp:TextBox ID="txtGSTRateCode" runat="Server" CssClass="txt" TabIndex="17" Width="80px"
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="6" style="width: 10%;">
                                <asp:TextBox ID="txtRDiffTender" runat="Server" CssClass="txt" TabIndex="18" Width="110px"
                                    Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtRDiffTender_TextChanged" ReadOnly="true"
                                ...
                                <asp:TextBox ID="txtNarration1" runat="Server" CssClass="txt" TabIndex="19" Width="320px"
                                    onkeydown="Narration1(event);" Style="text-align: left;" AutoPostBack="false" OnTextChanged="txtNarration1_TextChanged"
                                    Height="24px"></asp:TextBox>
                                <asp:Button ID="btntxtNarration1" runat="server" Text="..." OnClick="btntxtNarration1_Click"
                                    CssClass="btnHelp" Height="24px" Width="20px" />
                                Narration2:
                            &emsp;&emsp;
                                <asp:TextBox ID="txtNarration2" runat="Server" CssClass="txt" TabIndex="20" Width="300px"
                                    onkeydown="Narration2(event);" Style="text-align: left;" AutoPostBack="false" OnTextChanged="txtNarration2_TextChanged"
                                    Height="24px"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="6" style="width: 10%;">
                                <asp:TextBox ID="txtPostage" runat="Server" CssClass="txt" TabIndex="21" Width="110px"
                                    Style="text-align: right;" AutoPostBack="false" OnTextChanged="txtPostage_TextChanged"
                                    Visible="false" Height="24px"></asp:TextBox><ajax1:FilteredTextBoxExtender runat="server" ID="FilteredTextBoxExtender6"
                                        FilterType="Custom,Numbers" ValidChars="." TargetControlID="txtPostage">
                                    </ajax1:FilteredTextBoxExtender>
                                &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                                Narration3:
                                &emsp;
                                     <asp:TextBox ID="txtNarration3" runat="Server" CssClass="txt" TabIndex="22" Width="320px"
                                         onkeydown="Narration3(event);" Style="text-align: left;" AutoPostBack="false" OnTextChanged="txtNarration3_TextChanged"
                                         Height="24px"></asp:TextBox>
                                <asp:Button ID="btntxtNarration3" runat="server" Text="..." OnClick="btntxtNarration3_Click"
                                    CssClass="btnHelp" Height="24px" Width="20px" />
                                Narration4:
                           &emsp; &emsp;
                                <asp:TextBox ID="txtNarration4" runat="Server" CssClass="txt" TabIndex="23" Width="300px"
                                    onkeydown="Narration4(event);" Style="text-align: left;" AutoPostBack="false" OnTextChanged="txtNarration4_TextChanged"
                                    Height="24px"></asp:TextBox>
                        ...
                        <tr>
                            <td align="left" style="width: 10%;">Resell Comm'n:</td>
                            <td align="left" colspan="6" style="width: 10%;">
                                <asp:TextBox runat="server" ID="txtCommissionPerQntl" Width="40px"
                                    TabIndex="24" AutoPostBack="true" Height="20px" OnTextChanged="txtCommissionPerQntl_TextChanged"></asp:TextBox>

                                <asp:TextBox ID="txtResale_Commisson" runat="Server" CssClass="txt" TabIndex="25"
                        ...
                        <tr>
                            ...
                            <td style="">
                                <asp:TextBox ID="txtSGSTRate" runat="Server" CssClass="txt" Width="50px" TabIndex="29"
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 10%;">
                                <asp:TextBox ID="txtOTHER_Expenses" runat="Server" CssClass="txt" TabIndex="30" Width="110px"
                            ...
                            <td style="">
                                <asp:TextBox ID="txtIGSTRate" runat="Server" CssClass="txt" Width="52px" AutoPostBack="true"
                                    OnTextChanged="txtIGSTRate_TextChanged" TabIndex="31" Style="text-align: right;"
                                    Height="24px"></asp:TextBox>
