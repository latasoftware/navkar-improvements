...
public partial class Sugar_Master_PgeShugarSalerUtility : System.Web.UI.Page
{
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, int PageSize, int Company_Code, int year)
    {
        ...
        foreach (var s in split)
        {
            ...
            name += "( Ac_Name_E like '%" + aa + "%' or doc_no like '%" + aa + "%' or doc_dateConverted like '%" + aa + "%' or NETQNTL like '%" + aa + "%' or Bill_Amount like '%" + aa + "%' or srid like '%" + aa + "%') and";
       ...
       + "Ac_Name_E ,NETQNTL,Bill_Amount,srid FROM qrysugarsalereturnhead    where " + name + " and Company_Code=" + Company_Code + " " +
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
       ...
       + "Ac_Name_E ,NETQNTL,Bill_Amount,srid FROM " + qryCommon + " limit 15";
