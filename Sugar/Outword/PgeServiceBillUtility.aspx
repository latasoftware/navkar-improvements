<%@ Page Language="C#" Title="ServiceBill Utility" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="PgeServiceBillUtility.aspx.cs" Inherits="Sugar_Master_PgeServiceBillUtility" %>
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(5).html($(this).find("rbid").text());
