<%@ Page Language="C#" Title="Sale Utility" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="PgeSaleHeadUtility.aspx.cs" Inherits="Sugar_Master_PgeSaleHeadUtility" %>
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(2).html($(this).find("billtoname").text());
                    $("td", row).eq(3).html($(this).find("billtogstno").text());
                    $("td", row).eq(4).html($(this).find("shiptoname").text());
                    $("td", row).eq(5).html($(this).find("NETQNTL").text());
                    $("td", row).eq(6).html($(this).find("Bill_Amount").text());
                    $("td", row).eq(7).html($(this).find("millname").text());
                    $("td", row).eq(8).html($(this).find("saleid").text());
            ...
            <div id="popup" style="max-height: 600px; overflow-y: scroll;">
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1500px"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="100px" DataField="billtoname" HeaderText="Bill To Name" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="billtogstno" HeaderText="Bill To GST No" />
                        <asp:BoundField HeaderStyle-Width="100px" DataField="shiptoname" HeaderText="Ship To Name" />
