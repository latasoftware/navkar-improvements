...
public partial class Sugar_Master_PgeSaleHeadUtility : System.Web.UI.Page
{
    ...
    private void BindDummyRow()
    {
        ...
        dummy.Columns.Add("billtoname");
        dummy.Columns.Add("billtogstno");
        dummy.Columns.Add("shiptoname");
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, int PageSize, int Company_Code, int year)
    {
        ...
        foreach (var s in split)
        {
            ...
            name += "( billtoname like '%" + aa + "%' or shiptoname like '%" + aa + "%' or millname like '%" + aa + "%' or doc_no like '%" + aa + "%' or doc_dateConverted like '%" + aa + "%' or billtogstno like '%" + aa + "%' or NETQNTL like '%" + aa + "%' or Bill_Amount like '%" + aa + "%' or saleid like '%" + aa + "%' ) and";
       ...
       + "billtoname ,billtogstno,shiptoname,NETQNTL,Bill_Amount,millname,saleid FROM qrysalehead   where " + name + " and Company_Code=" + Company_Code + " " +
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
       ...
       + "billtoname ,billtogstno,shiptoname,NETQNTL,Bill_Amount,millname,saleid FROM " + qryCommon + " limit 15";
