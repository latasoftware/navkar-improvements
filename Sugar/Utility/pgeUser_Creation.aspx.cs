...
public partial class Sugar_Utility_pgeUser_Creation : System.Web.UI.Page
{
    ...
    {
        int maxno = Convert.ToInt32(clsCommon.getString("select ifnull(max(uid),0) as uid from tbluser "));
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        User_Id = Convert.ToInt32(txtUser_Id.Text != string.Empty ? txtUser_Id.Text : "0");
        uid = lbluid.Text != string.Empty ? Convert.ToInt32(lbluid.Text) : 0;
        userFull_name = txtuserfullname.Text;
        User_Name = txtUser_Name.Text;
        EncryptPass encr = new EncryptPass();
        Password = encr.Encrypt(txtPassword.Text);
        EmailId = txtEmailId.Text;
        EmailPassword = encr.Encrypt(txtEmailPassword.Text);
        Mobile_no = txtMobile.Text;
        User_Type = drpUser_Type.SelectedValue;
        ...
        Detail_Fields = "Detail_Id,User_Id,Tran_Type,Program_Name,Permission,Company_Code,udid,uid";


        #endregion

        #region Detail Fields
        Detail_Fields_Report = "Detail_Id,User_Id,Tran_Type,Program_Name,Permission,Company_Code,udrid,uid";
        ...
        if (btnSave.Text == "Save")
        {
            ...
            Head_Fields = "User_Id,";
            Head_Values = "'" + User_Id + "',";
            Head_Fields = Head_Fields + "userfullname,";
            Head_Values = Head_Values + "'" + userFull_name + "',";
            Head_Fields = Head_Fields + "User_Name,";
            Head_Values = Head_Values + "'" + User_Name + "',";
            Head_Fields = Head_Fields + "Password,";
            Head_Values = Head_Values + "'" + Password + "',";
            Head_Fields = Head_Fields + "EmailId,";
            Head_Values = Head_Values + "'" + EmailId + "',";
            Head_Fields = Head_Fields + "EmailPassword,";
            Head_Values = Head_Values + "'" + EmailPassword + "',";
            Head_Fields = Head_Fields + "Mobile,";
            Head_Values = Head_Values + "'" + Mobile_no + "',";
            Head_Fields = Head_Fields + "User_Type,";
            Head_Values = Head_Values + "'" + User_Type + "',";
            Head_Fields = Head_Fields + "uid,";
            Head_Values = Head_Values + "'" + uid + "' ,";
            ...
            #region Detail Part
            int userdetailid = Convert.ToInt32(clsCommon.getString("select ifnull (max(udid),0) from tbluserdetail"));
            if (userdetailid == 0)
            {
                userdetailid = 0;
            }
            ...
            for (int i = 0; i < grdDetail.Rows.Count; i++)
            {
                ...
                Grid_Userid = Convert.ToInt32(txtUser_Id.Text != string.Empty ? txtUser_Id.Text : "0");
                Grid_Trantype = Convert.ToString(grdDetail.Rows[i].Cells[Tran_Type].Text);
                Grid_Programname = Convert.ToString(grdDetail.Rows[i].Cells[Program_Name].Text);
                CheckBox chkpermission = (CheckBox)grdDetail.Rows[i].Cells[3].FindControl("chkpermission");
                ...
                Year_Code = Convert.ToInt32(Session["year"].ToString());
                Grid_udid = lbluid.Text != string.Empty ? Convert.ToInt32(lbluid.Text) : 0;
                // Detail_Fields = "Detail_Id,User_Id,Tran_Type,Program_Name,Permission,Company_Code,udid,uid";
                Detail_Values = Detail_Values + "('" + Grid_Id + "','" + Grid_Userid + "','" + Grid_Trantype + "','" +
                    Grid_Programname + "','" + Grid_Permission + "'," +
                    " '" + Company_Code + "','" + userdetailid + "','" + Grid_udid + "'),";
            }
            #endregion
            ...
            #region Detail Part Report
            int USERRID = Convert.ToInt32(clsCommon.getString("select ifnull (max(udrid),0) from tbluserdetail_report"));
            if (USERRID == 0)
            {
                USERRID = 0;
            }
            ...
            {
                USERRID = USERRID + 1;
                GridDetail_IdReport = Convert.ToInt32(grdDetail_Report.Rows[i].Cells[Detail_Id_Report].Text);
                GridUser_IdReport = Convert.ToInt32(txtUser_Id.Text != string.Empty ? txtUser_Id.Text : "0");
                GridTran_TypeReport = Convert.ToString(grdDetail_Report.Rows[i].Cells[Tran_Type_Report].Text);
                GridProgram_NameReport = Convert.ToString(grdDetail_Report.Rows[i].Cells[Program_Name_Report].Text);
                ...
                if (chkpermission.Checked == true)
                {
                    ...
                    GridPermissionReport = "Y";

                }
                else
                {

                    GridPermissionReport = "N";
                }
                ...
                Year_Code = Convert.ToInt32(Session["year"].ToString());
                Gridudrid = lbluid.Text != string.Empty ? Convert.ToInt32(lbluid.Text) : 0;
                //  Detail_Fields_Report = "Detail_Id,User_Id,Tran_Type,Program_Name,Permission,Company_Code,udrid,uid";


                Detail_Values_Report = Detail_Values_Report + "('" + GridDetail_IdReport + "','" + GridUser_IdReport + "','" +
                    GridTran_TypeReport + "','" + GridProgram_NameReport + "','" + GridPermissionReport + "'," +
                    " '" + Company_Code + "','" +
                    USERRID + "','" + Gridudrid + "'),";
            }
            #endregion

            if (Detail_Values_Report.Length > 0)
            {
                Detail_Values_Report = Detail_Values_Report.Remove(Detail_Values_Report.Length - 1);
                Detail_Insert_Report = "insert into " + tblDetailReport + "(" + Detail_Fields_Report + ") values " + Detail_Values_Report + "";
        ...
        else
        {
            ...
            Head_Update = Head_Update + "userfullname=";
            Head_Update = Head_Update + "'" + userFull_name + "',";
            Head_Update = Head_Update + "User_Name=";
            Head_Update = Head_Update + "'" + User_Name + "',";
            Head_Update = Head_Update + "Password=";
            Head_Update = Head_Update + "'" + Password + "',";
            Head_Update = Head_Update + "EmailId=";
            Head_Update = Head_Update + "'" + EmailId + "',";
            Head_Update = Head_Update + "EmailPassword=";
            Head_Update = Head_Update + "'" + EmailPassword + "',";
            Head_Update = Head_Update + "Mobile=";
            Head_Update = Head_Update + "'" + Mobile_no + "',";
            Head_Update = Head_Update + "User_Type=";
            Head_Update = Head_Update + "'" + User_Type + "'";


            Head_Update = "update " + tblHead + " set " + Head_Update + " where uid=" + lbluid.Text + "";
            #endregion
            string concatid = string.Empty;
            int utrDid = Convert.ToInt32(clsCommon.getString("select max(udid) as udid from " + tblDetails + " "));
            for (int i = 0; i < grdDetail.Rows.Count; i++)
            {
                ...
                Year_Code = Convert.ToInt32(Session["year"].ToString());
                //Grid_udid = lbluid.Text != string.Empty ? Convert.ToInt32(lbluid.Text) : 0;
                DID = Convert.ToInt32(grdDetail.Rows[i].Cells[0].Text);
                ...
                {
                    utrDid = utrDid + 1;
                    Detail_Values = Detail_Values + "('" + Grid_Id + "','" + Grid_Userid + "','" + Grid_Trantype + "','" + Grid_Programname + "','" + Grid_Permission + "'," +
                      " '" + Company_Code + "','" + utrDid + "','" + uid + "'),";
                }
                #endregion
                #region Update Grid Record
                if (grdDetail.Rows[i].Cells[Rowaction].Text == "U" || grdDetail.Rows[i].Cells[Rowaction].Text == "N")
                {
                    Detail_Update = Detail_Update + "Program_Name=case Detail_Id when '" + DID + "' then '" + Grid_Programname +
                        "'  ELSE Program_Name END,";
                    Detail_Update = Detail_Update + "Tran_Type=case Detail_Id when '" + DID +
                        "' then '" + Grid_Trantype + "'  ELSE Tran_Type END,";
                    Detail_Update = Detail_Update + "Permission=case Detail_Id when '" + DID +
                      "' then '" + Grid_Permission + "'  ELSE Permission END,";

                    concatid = concatid + "'" + DID + "',";
                ...
                {
                    Detail_Delete = Detail_Delete + "'" + grdDetail.Rows[i].Cells[Detail_Id].Text + "',";
                }
                #endregion
            ...
            if (Detail_Update.Length > 0)
            {
                ...
                Detail_Update = Detail_Update.Remove(Detail_Update.Length - 1);
                Detail_Update = "update " + tblDetails + " set " + Detail_Update + " where Detail_Id in(" + concatid + ") and uid=" + uid;
            ...
            utrDid = Convert.ToInt32(clsCommon.getString("select ifnull(max(udrid),0) as udid from " + tblDetailReport + " "));
            for (int i = 0; i < grdDetail_Report.Rows.Count; i++)
            {

                Grid_Id = Convert.ToInt32(grdDetail_Report.Rows[i].Cells[Detail_Id].Text);
                Grid_Userid = Convert.ToInt32(txtUser_Id.Text != string.Empty ? txtUser_Id.Text : "0");
                Grid_Trantype = Convert.ToString(grdDetail_Report.Rows[i].Cells[Tran_Type].Text);
                Grid_Programname = Convert.ToString(grdDetail_Report.Rows[i].Cells[Program_Name].Text);
                CheckBox chkpermission = (CheckBox)grdDetail_Report.Rows[i].Cells[3].FindControl("chkpermission");
                if (chkpermission.Checked == true)
                {
                    Grid_Permission = "Y";
                ...
                Year_Code = Convert.ToInt32(Session["year"].ToString());
                //Grid_udid = lbluid.Text != string.Empty ? Convert.ToInt32(lbluid.Text) : 0;
                DID = Convert.ToInt32(grdDetail_Report.Rows[i].Cells[0].Text);
                #region Insert Grid Record
                // Detail_Fields_Report = "Detail_Id,User_Id,Tran_Type,Program_Name,Permission,Company_Code,udrid,uid";

                if (grdDetail_Report.Rows[i].Cells[Rowaction].Text == "A")
                {
                    utrDid = utrDid + 1;
                    Detail_Values_Report = Detail_Values_Report + "('" + Grid_Id + "','" + Grid_Userid + "','" + Grid_Trantype + "','"
                        + Grid_Programname + "','" + Grid_Permission + "'," +
                      " '" + Company_Code + "','" + utrDid + "','" + uid + "'),";
                }
                #endregion
                #region Update Grid Record
                if (grdDetail_Report.Rows[i].Cells[Rowaction].Text == "U" || grdDetail_Report.Rows[i].Cells[Rowaction].Text == "N")
                {
                    Detail_Update_Report = Detail_Update_Report + "Program_Name=case Detail_Id when '" + DID + "' then '"
                        + Grid_Programname +
                        "'  ELSE Program_Name END,";
                    Detail_Update_Report = Detail_Update_Report + "Tran_Type=case Detail_Id when '" + DID +
                        "' then '" + Grid_Trantype + "'  ELSE Tran_Type END,";
                    Detail_Update_Report = Detail_Update_Report + "Permission=case Detail_Id when '" + DID +
                      "' then '" + Grid_Permission + "'  ELSE Permission END,";
                ...
                #endregion
                #region Delete Grid Record
                //if (grdDetail_Report.Rows[i].Cells[Rowaction].Text == "D")
                //{
                //    Detail_Delete_Report = Detail_Delete_Report + "'" + grdDetail_Report.Rows[i].Cells[Detail_Id].Text + "',";
                //}
                #endregion
            ...
            if (Detail_Update_Report.Length > 0)
            {
                concatid = concatid.Remove(concatid.Length - 1);
                Detail_Update_Report = Detail_Update_Report.Remove(Detail_Update_Report.Length - 1);
                Detail_Update_Report = "update " + tblDetailReport + " set " + Detail_Update_Report +
                    " where Detail_Id in(" + concatid + ") and uid=" + uid;

            }
            #endregion

            #region Pass Qry To Process
            flag = 2;
            Thread thred = new Thread(() => { count = DataStore(flag); }); //Calling DataStore Method Using Thread
            thred.Start(); //Thread Operation Start
            thred.Join();
    ...
    private int DataStore(int flag)
    {
        ...
        try
        {
            ...
            if (flag == 1)
            {
                ...
                cmd.ExecuteNonQuery();
                cmd = new MySqlCommand(Detail_Insert_Report, con, myTran);
                cmd.ExecuteNonQuery();
                myTran.Commit();
                Thread.Sleep(100);
            ...
            else if (flag == 2)
            {
                ...
                {
                    cmd = new MySqlCommand(Detail_Update_Report, con, myTran);
                    cmd.ExecuteNonQuery();
                }
