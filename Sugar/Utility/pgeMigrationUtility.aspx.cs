...
{
    string mysqlconn = ConfigurationManager.ConnectionStrings["ConnectionString1"].ConnectionString;
    string sqlconn = ConfigurationManager.ConnectionStrings["sqlconnection"].ConnectionString;

    SqlConnection sqlcon;
    MySqlConnection mysqcon;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        mysqcon = new MySqlConnection(mysqlconn);
        if (!Page.IsPostBack)
        {
    ...
    protected void btnCityMaster_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand(cityqrymysql, mysqcon);
        MySqlDataAdapter returnVal = new MySqlDataAdapter(cityqrymysql, mysqcon);
    ...
    protected void btnaccountmaster_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmdgrp = new MySqlCommand(groupmaster, mysqcon);
        MySqlDataAdapter returnValgrp = new MySqlDataAdapter(groupmaster, mysqcon);
        DataTable dtgroup = new DataTable();
        returnValgrp.Fill(dtgroup);

        string citymaster = "select * from nt_1_citymaster";
        MySqlCommand cmdcitymaster = new MySqlCommand(citymaster, mysqcon);
        MySqlDataAdapter returnValcitymaster = new MySqlDataAdapter(citymaster, mysqcon);
        ...
        if (dt3.Rows.Count > 0)
        {
            try
            {
                ...
                for (int i = 0; i < dt3.Rows.Count; i++)
                {
                    ...
                    MySqlCommand MySQLcmd1 = new MySqlCommand(insert, mysqcon, transaction);
        ...
        MySqlCommand cmdNT_1_AcContacts = new MySqlCommand(NT_1_AcContacts, mysqcon);
        MySqlDataAdapter returnValNT_1_AcContacts = new MySqlDataAdapter(NT_1_AcContacts, mysqcon);
        ...
        cmd = new MySqlCommand(cityqrymysql, mysqcon);
        returnVal = new MySqlDataAdapter(cityqrymysql, mysqcon);
        dt = new DataTable();
        returnVal.Fill(dt);
    ...
    protected void btnpartyunit_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmdacc = new MySqlCommand(acc, mysqcon);
        MySqlDataAdapter returnValacc = new MySqlDataAdapter(acc, mysqcon);
    ...
    protected void btnitemmaster_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand(itemmastermysql, mysqcon);
        MySqlDataAdapter returnVal = new MySqlDataAdapter(itemmastermysql, mysqcon);
        DataTable dt = new DataTable();
        returnVal.Fill(dt);
    ...
    protected void btnupdatecitygst_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand nullcity1 = new MySqlCommand(nullcity, mysqcon);
        MySqlDataAdapter nullcityda = new MySqlDataAdapter(nullcity, mysqcon);
        ...
        MySqlCommand acccmd = new MySqlCommand(acc, mysqcon);
        MySqlDataAdapter accda = new MySqlDataAdapter(acc, mysqcon);
        //DataTable dtnulllcity = new DataTable();
        accda.Fill(dt);
        //dt = dt.AsEnumerable()
    ...
    protected void btnpssbid_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd1 = new MySqlCommand(cityqrymysql1, mysqcon);
        MySqlDataAdapter returnVal1 = new MySqlDataAdapter(cityqrymysql1, mysqcon);
        DataTable dt1 = new DataTable();
        returnVal1.Fill(dt1);

        string cityqrymysql11 = "select * from nt_1_sugarsale where Purcid is null";
        MySqlCommand cmd11 = new MySqlCommand(cityqrymysql1, mysqcon);
        MySqlDataAdapter returnVal11 = new MySqlDataAdapter(cityqrymysql11, mysqcon);
    ...
    protected void btnTender_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand(Tenderpurchase, mysqcon);
        MySqlDataAdapter returnVal = new MySqlDataAdapter(Tenderpurchase, mysqcon);
        DataTable dt = new DataTable();
        returnVal.Fill(dt);


        string mysqlaccountMaster = "select * from nt_1_accountmaster where Company_Code=" + drpCompany.SelectedValue + " ";
        MySqlCommand cmdmysqlaccountMaster = new MySqlCommand(mysqlaccountMaster, mysqcon);
        MySqlDataAdapter returnValmysqlaccountMaster = new MySqlDataAdapter(mysqlaccountMaster, mysqcon);
        ...
        cmd = new MySqlCommand(Tenderpurchase, mysqcon);
        returnVal = new MySqlDataAdapter(Tenderpurchase, mysqcon);
        dt = new DataTable();
        returnVal.Fill(dt);

        string Tenderpurchaseselect = "select * from nt_1_tender where Company_Code=" + drpCompany.SelectedValue + " order by Tender_No";
        MySqlCommand cmdTenderpurchaseselect = new MySqlCommand(Tenderpurchaseselect, mysqcon);
        MySqlDataAdapter returnValTenderpurchaseselect = new MySqlDataAdapter(Tenderpurchaseselect, mysqcon);
        ...
        cmdmysqlaccountMaster = new MySqlCommand(mysqlaccountMaster, mysqcon);
    ...
    protected void btnDO_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand(mysqlDO, mysqcon);
        MySqlDataAdapter returnVal = new MySqlDataAdapter(mysqlDO, mysqcon);
        DataTable dt = new DataTable();
        returnVal.Fill(dt);
        ...
        MySqlCommand cmdmysqlCarporate = new MySqlCommand(mysqlCarporate, mysqcon);
        MySqlDataAdapter mysqlDaCarporate = new MySqlDataAdapter(mysqlCarporate, mysqcon);
        ...
        MySqlCommand cmdmyTender = new MySqlCommand(mysqlTenderDetail, mysqcon);
        MySqlDataAdapter mysqltender = new MySqlDataAdapter(mysqlTenderDetail, mysqcon);
        ...
        MySqlCommand cmdSaleBill = new MySqlCommand(mysqlSaleBill, mysqcon);
        MySqlDataAdapter DASaleBill = new MySqlDataAdapter(mysqlSaleBill, mysqcon);
...
",EWayBillChk,MillInvoiceNo,Purchase_Date,doid,mc,gp,st,sb,tc,itemcode,cs,ic,tenderdetailid,bk,docd,vb,va,carporate_ac,ca,mill_inv_date,mill_rcv,saleid";
        ...
        if (dt3.Rows.Count > 0)
        {
            ...
            try
            {
                ...
                mysqcon.Open();
                transaction = mysqcon.BeginTransaction();
                MySqlCommand MySQLcmd1 = new MySqlCommand();
                for (i = 0; i < dt3.Rows.Count; i++)
                {
                    ...
                    MySQLcmd1 = new MySqlCommand(insert, mysqcon, transaction);
                    MySQLcmd1.ExecuteNonQuery();
        ...
        cmd = new MySqlCommand(mysqlDOdetail, mysqcon);
        returnVal = new MySqlDataAdapter(mysqlDOdetail, mysqcon);
        dt = new DataTable();
        returnVal.Fill(dt);

        string mysqlDo = "select * from nt_1_deliveryorder where  Company_Code=" + drpCompany.SelectedValue +
            " order by doc_no";
        MySqlCommand cmdDO = new MySqlCommand(mysqlDo, mysqcon);
        MySqlDataAdapter returnValDO = new MySqlDataAdapter(mysqlDo, mysqcon);
        ...
        string mysqlutr = "select * from nt_1_utrdetail where  Company_Code=" + drpCompany.SelectedValue +
            " order by doc_no";
        MySqlCommand cmdutr = new MySqlCommand(mysqlutr, mysqcon);
        MySqlDataAdapter returnValutr = new MySqlDataAdapter(mysqlutr, mysqcon);
    ...
    protected void btnCarporate_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand(Carporate, mysqcon);
        MySqlDataAdapter returnVal = new MySqlDataAdapter(Carporate, mysqcon);
        DataTable dt = new DataTable();
        returnVal.Fill(dt);
    ...
    protected void btnutr_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand(utrentry, mysqcon);
        MySqlDataAdapter returnVal = new MySqlDataAdapter(utrentry, mysqcon);
        DataTable dt = new DataTable();
        returnVal.Fill(dt);
        ...
        cmd = new MySqlCommand(utrdetail, mysqcon);
        returnVal = new MySqlDataAdapter(utrdetail, mysqcon);
        dt = new DataTable();
        returnVal.Fill(dt);

        string utrselect = "select * from nt_1_utr where Company_Code=" + drpCompany.SelectedValue + " order by doc_no";
        MySqlCommand cmdutrseselect = new MySqlCommand(utrselect, mysqcon);
        MySqlDataAdapter returnValutrEntryseselect = new MySqlDataAdapter(utrselect, mysqcon);
        ...
        MySqlCommand cmdsql1 = new MySqlCommand(Tenderpurchasesql1, mysqcon);

        MySqlDataAdapter returnValSQL1 = new MySqlDataAdapter(Tenderpurchasesql1, mysqcon);
        ...
        MySqlCommand cmdtenterenrty = new MySqlCommand(tenderentry, mysqcon);
        MySqlDataAdapter retuntenderentry = new MySqlDataAdapter(tenderentry, mysqcon);
    ...
    protected void btnSaleBill_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand(salebill, mysqcon);
        MySqlDataAdapter returnVal = new MySqlDataAdapter(salebill, mysqcon);
        DataTable dt = new DataTable();
        returnVal.Fill(dt);
        ...
        MySqlCommand cmdPurchase = new MySqlCommand(Purchase, mysqcon);
        MySqlDataAdapter returnPurchase = new MySqlDataAdapter(Purchase, mysqcon);
...
",IGSTAmount,TaxableAmount,EWay_Bill_No,EWayBill_Chk,MillInvoiceNo,RoundOff,saleid,ac,uc,mc,bk,tc,Purcid";
        ...
        cmd = new MySqlCommand(SaleBillDetail, mysqcon);
        returnVal = new MySqlDataAdapter(SaleBillDetail, mysqcon);
        dt = new DataTable();
        returnVal.Fill(dt);

        string SaleBillHead = "select * from nt_1_sugarsale where  Company_Code=" + drpCompany.SelectedValue +
            " order by doc_no";
        MySqlCommand cmdSaleBill = new MySqlCommand(SaleBillHead, mysqcon);
        MySqlDataAdapter returnValSaleBillHead = new MySqlDataAdapter(SaleBillHead, mysqcon);
        ...
        MySqlCommand cmdmysqlItem_Master = new MySqlCommand(mysqlItem_Master, mysqcon);
        MySqlDataAdapter MysqlDAItem = new MySqlDataAdapter(mysqlItem_Master, mysqcon);
    ...
    protected void btnpurches_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand(purchesEntry, mysqcon);
        MySqlDataAdapter returnVal = new MySqlDataAdapter(purchesEntry, mysqcon);
        DataTable dt = new DataTable();
        returnVal.Fill(dt);
        ...
        cmd = new MySqlCommand(DoEntry, mysqcon);
        returnVal = new MySqlDataAdapter(DoEntry, mysqcon);
        ...
        cmd = new MySqlCommand(mysqlPurcDetail, mysqcon);
        returnVal = new MySqlDataAdapter(mysqlPurcDetail, mysqcon);
        dt = new DataTable();
        returnVal.Fill(dt);
        ...
        string mysqlpurched = "select * from nt_1_sugarpurchase where  Company_Code=" + drpCompany.SelectedValue +
           " order by doc_no";
        MySqlCommand cmdDO = new MySqlCommand(mysqlpurched, mysqcon);
        MySqlDataAdapter returnValDO = new MySqlDataAdapter(mysqlpurched, mysqcon);
        DataTable dtDO = new DataTable();
        returnValDO.Fill(dtDO);
        ...
        MySqlCommand CmdItem = new MySqlCommand(mysqlitem, mysqcon);
        MySqlDataAdapter returnpurce = new MySqlDataAdapter(mysqlitem, mysqcon);
        ...
        if (dt3.Rows.Count > 0)
        {
            try
            {
                ...
                string q = "update navkar.nt_1_sugarpurchasedetails as p, navkar.qrymstitem as i set p.ic = i.systemid where p.item_code=i.System_Code ";
                MySqlCommand MySQLcmd = new MySqlCommand(q, mysqcon, transaction);
    ...
    ",IsTDS,TDS_Ac,TDS_Per,TDSAmount,TDS,Company_Code,Year_Code,Branch_Code,Created_By,Modified_By,billno,cc,ta,rbid";
            ...
            MySqlCommand cmdmysqlRentHead = new MySqlCommand(mysqlRentHead, mysqcon);
            MySqlDataAdapter MymysqlRentHead = new MySqlDataAdapter(mysqlRentHead, mysqcon);
    ...
    protected void btnReciptPayment_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand(mysqlReciptPayment, mysqcon);
        MySqlDataAdapter returnVal = new MySqlDataAdapter(mysqlReciptPayment, mysqcon);
        DataTable dt = new DataTable();
        returnVal.Fill(dt);
        ...
        MySqlCommand cmdhead = new MySqlCommand(mysqlReciptPaymentHead, mysqcon);
        MySqlDataAdapter returnVal1 = new MySqlDataAdapter(mysqlReciptPaymentHead, mysqcon);
        ...
        MySqlCommand cmdDeatil = new MySqlCommand(mysqlReciptPaymentDetail, mysqcon);
        MySqlDataAdapter returnVal2 = new MySqlDataAdapter(mysqlReciptPaymentDetail, mysqcon);
        DataTable dtdetail = new DataTable();
        returnVal2.Fill(dtdetail);

        mysqlaccountMaster = "select * from nt_1_accountmaster where Company_Code=" + drpCompany.SelectedValue;
        cmdmysqlaccountMaster = new MySqlCommand(mysqlaccountMaster, mysqcon);
        MySqlDataAdapter returnValmysqlaccountMasterq = new MySqlDataAdapter(mysqlaccountMaster, mysqcon);
...
" Branch_name,YearCodeDetail,tranid,ca,uc,tenderdetailid,sbid,da,trandetailid,drcr";
    ...
    protected void btnReturn_Purchase_Click(object sender, EventArgs e)
    {
        ...
        cmd = new MySqlCommand(saleEntry, mysqcon);
        MySqlDataAdapter saleDa = new MySqlDataAdapter(saleEntry, mysqcon);
...
",Bill_To,prid,srid,ac,uc,mc,bc,bt,sbid";
    ...
    protected void btnsalereturn_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand(mysqlsugarsalereutun, mysqcon);
        MySqlDataAdapter returnVal = new MySqlDataAdapter(mysqlsugarsalereutun, mysqcon);
        DataTable dt = new DataTable();
        returnVal.Fill(dt);
        ...
        cmd = new MySqlCommand(mysqlsalereDetail, mysqcon);
        returnVal = new MySqlDataAdapter(mysqlsalereDetail, mysqcon);
        dt = new DataTable();
        returnVal.Fill(dt);
        ...
        string mysqlsalerehed = "select * from nt_1_sugarsalereturn where  Company_Code=" + drpCompany.SelectedValue +
           " order by doc_no";
        MySqlCommand cmdDO = new MySqlCommand(mysqlsalerehed, mysqcon);
        MySqlDataAdapter returnValDO = new MySqlDataAdapter(mysqlsalerehed, mysqcon);
        DataTable dtDO = new DataTable();
        returnValDO.Fill(dtDO);
    ...
    protected void btnLV_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand(CommisionBill, mysqcon);
        MySqlDataAdapter returnVal = new MySqlDataAdapter(CommisionBill, mysqcon);
        DataTable dt = new DataTable();
        returnVal.Fill(dt);
...
",bc,tc,mill_code,mc,narration1,narration2,narration3,narration4";
    ...
    protected void btnRatilsale_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmdmysqlaccountMaste1r = new MySqlCommand(mysqlaccountMasterdetail, mysqcon);
        MySqlDataAdapter returnValmysqlaccountMaster1 = new MySqlDataAdapter(mysqlaccountMasterdetail, mysqcon);
...
",grade,retailid,retaildetailid,ic,mc,purchaseid";
    ...
    protected void btnJournalvoucher_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand(mysqlJournalvoucher, mysqcon);
        MySqlDataAdapter returnVal = new MySqlDataAdapter(mysqlJournalvoucher, mysqcon);
        DataTable dt = new DataTable();
        returnVal.Fill(dt);
        ...
        MySqlCommand cmdhead = new MySqlCommand(mysqlJV, mysqcon);
        MySqlDataAdapter returnVal1 = new MySqlDataAdapter(mysqlJV, mysqcon);
        DataTable dthead = new DataTable();

        returnVal1.Fill(dthead);

        string mysqlJvDetail = "select * from nt_1_transactdetail where  Company_Code=" + drpCompany.SelectedValue + "  order by doc_no";
        MySqlCommand cmdDeatil = new MySqlCommand(mysqlJvDetail, mysqcon);
        MySqlDataAdapter returnVal2 = new MySqlDataAdapter(mysqlJvDetail, mysqcon);
        DataTable dtdetail = new DataTable();
        returnVal2.Fill(dtdetail);
...
" Branch_name,YearCodeDetail,tranid,ca,uc,tenderdetailid,sbid,trandetailid,drcr";
    ...
    protected void btnGledger_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand(mysqlGledegr, mysqcon);
        MySqlDataAdapter returnVal1 = new MySqlDataAdapter(mysqlGledegr, mysqcon);
        DataTable dt = new DataTable();
        returnVal1.Fill(dt);
    ...
    protected void btnotherPurches_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand(otherPEntry, mysqcon);
        MySqlDataAdapter returnVal = new MySqlDataAdapter(otherPEntry, mysqcon);
        DataTable dt = new DataTable();
        returnVal.Fill(dt);
...
"TDS_Amt,TDS_Per,TDS,TDS_Cutt_AcCode,TDS_AcCode,opid,sc,ea,tca,tac";
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd = new MySqlCommand(retail_Head, mysqcon, tran);
            cmd.CommandTimeout = 100;
            cmd.ExecuteNonQuery();

            string item = "delete from nt_1_systemmaster";
            cmd = new MySqlCommand(item, mysqcon, tran);
            cmd.CommandTimeout = 100;
            cmd.ExecuteNonQuery();

            string user = "delete from tbluser where User_Name!='demo'";
            cmd = new MySqlCommand(user, mysqcon, tran);
            cmd.CommandTimeout = 100;
            cmd.ExecuteNonQuery();

            string partyUnit = "delete from nt_1_partyunit ";
            cmd = new MySqlCommand(partyUnit, mysqcon, tran);
            cmd.CommandTimeout = 100;
            cmd.ExecuteNonQuery();

            string acc_group = "delete from nt_1_acgroups ";
            cmd = new MySqlCommand(acc_group, mysqcon, tran);
            cmd.CommandTimeout = 100;
            cmd.ExecuteNonQuery();

            string acc_Detail = "delete from nt_1_accontacts ";
            cmd = new MySqlCommand(acc_Detail, mysqcon, tran);
            cmd.CommandTimeout = 100;
            cmd.ExecuteNonQuery();

            string account = "delete from nt_1_accountmaster ";
            cmd = new MySqlCommand(account, mysqcon, tran);
            cmd.CommandTimeout = 100;
            cmd.ExecuteNonQuery();

            string city = "delete from nt_1_citymaster ";
            cmd = new MySqlCommand(city, mysqcon, tran);
            cmd.CommandTimeout = 100;
            cmd.ExecuteNonQuery();

            string groupMaster = "delete from nt_1_bsgroupmaster ";
            cmd = new MySqlCommand(groupMaster, mysqcon, tran);
            cmd.CommandTimeout = 100;
            cmd.ExecuteNonQuery();
    ...
    protected void btnYear_Click(object sender, EventArgs e)
    {
        ...
        if (dt3.Rows.Count > 0)
        {
            try
            {
                ...
                MySqlCommand MySQLcmd1 = new MySqlCommand(cityqrymysql, mysqcon, transaction);
                MySQLcmd1.ExecuteNonQuery();
                for (int i = 0; i < dt3.Rows.Count; i++)
                {
