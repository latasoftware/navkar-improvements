...
public partial class Sugar_pgeSelectYear : System.Web.UI.Page
{
    ...
    protected void lnkYear_Click(object sender, EventArgs e)
    {
        ...
        string qry = "select date_format(Start_Date,'%d/%m/%Y') as Start_Date,date_format(End_Date,'%d/%m/%Y') as End_Date from AccountingYear where yearCode=" + Session["year"].ToString();
