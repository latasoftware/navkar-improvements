<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgeOther_Purchase.aspx.cs" Inherits="pgeOther_Purchase" %>
                ...
                <tr>
                    <td align="center">
                        <asp:Button ID="btnAdd" runat="server" Text="Add New" CssClass="btnHelp" Width="90px"
                            TabIndex="21" ValidationGroup="save" OnClick="btnAdd_Click" Height="24px" />
                        &nbsp;
                        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btnHelp" Width="90px"
                            TabIndex="22" ValidationGroup="add" OnClick="btnSave_Click" Height="24px" />
                        &nbsp;
                        <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="btnHelp" Width="90px"
                            TabIndex="23" ValidationGroup="save" OnClick="btnEdit_Click" Height="24px" />
                        &nbsp;
                        <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btnHelp" Width="90px"
                            TabIndex="24" ValidationGroup="add" OnClick="btnDelete_Click" OnClientClick="Confirm()" Height="24px" />
                        &nbsp;
                        <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btnHelp" Width="90px"
                            TabIndex="25" ValidationGroup="save" OnClick="btnCancel_Click" Height="24px" />
                        &nbsp;
                        <asp:Button ID="btnBack" runat="server" Text="Back" CssClass="btnHelp" Width="90px"
                            TabIndex="26" ValidationGroup="save" Height="24px" OnClientClick="Back();" />
                    </td>
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table style="width: 50%;" align="center" cellpadding="4" cellspacing="4">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox Height="24px" ID="txtSupplier_Code" runat="Server" CssClass="txt" TabIndex="3"
                                Width="90px" Style="text-align: left;" OnkeyDown="supplier(event);" AutoPostBack="false" OnTextChanged="txtSupplier_Code_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox Height="24px" ID="txtExp_Ac" runat="Server" CssClass="txt" TabIndex="4"
                                Width="90px" Style="text-align: left;" OnkeyDown="expaccount(event);" AutoPostBack="false" OnTextChanged="txtExp_Ac_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox Height="24px" ID="txtGST_RateCode" runat="Server" CssClass="txt" TabIndex="5"
                                Width="90px" Style="text-align: left;" OnkeyDown="gstcode(event);" AutoPostBack="false" OnTextChanged="txtGST_RateCode_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox Height="24px" ID="txtCGST_Rate" runat="Server" CssClass="txt" TabIndex="7"
                                Width="40px" ReadOnly="true" Style="text-align: right;" AutoPostBack="false" OnTextChanged="txtCGST_Rate_TextChanged"></asp:TextBox>
                            <asp:TextBox Height="24px" ReadOnly="true" ID="txtCGST_Amount" runat="Server" CssClass="txt" TabIndex="8"
                                Width="90px" Style="text-align: right;" AutoPostBack="false" OnTextChanged="txtCGST_Amount_TextChanged"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox Height="24px" ID="txtSGST_Rate" runat="Server" CssClass="txt" TabIndex="9"
                                Width="40px" ReadOnly="true" Style="text-align: right;" AutoPostBack="false" OnTextChanged="txtSGST_Rate_TextChanged"></asp:TextBox>
                            <asp:TextBox Height="24px" ReadOnly="true" ID="txtSGST_Amount" runat="Server" CssClass="txt" TabIndex="10"
                                Width="90px" Style="text-align: right;" AutoPostBack="false" OnTextChanged="txtSGST_Amount_TextChanged"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox Height="24px" ID="txtIGST_Rate" runat="Server" CssClass="txt" TabIndex="11"
                                Width="40px" ReadOnly="true" Style="text-align: right;" AutoPostBack="false" OnTextChanged="txtIGST_Rate_TextChanged"></asp:TextBox>
                            <asp:TextBox Height="24px" ID="txtIGST_Amount" runat="Server" CssClass="txt" TabIndex="12"
                                Width="90px" ReadOnly="true" Style="text-align: right;" AutoPostBack="false" OnTextChanged="txtIGST_Amount_TextChanged"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox Height="24px" ID="txtTDSCuttAc_Code" runat="Server" CssClass="txt" TabIndex="18"
                                Width="90px" Style="text-align: left;" OnkeyDown="tdscutting(event);" AutoPostBack="false" OnTextChanged="txtTDSCuttAc_Code_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox Height="24px" ID="txtTDSAc_Code" runat="Server" CssClass="txt" TabIndex="19"
                                Width="90px" Style="text-align: left;" OnkeyDown="tdsac(event);" AutoPostBack="false" OnTextChanged="txtTDSAc_Code_TextChanged"></asp:TextBox>
                            <asp:Button Width="20px" Height="24px" ID="btntxtTDSAc_Code" runat="server" Text="..." OnClick="btntxtTDSAc_Code_Click"
                                CssClass="btnHelp" />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox Height="70px" ID="txtNarration" runat="Server" CssClass="txt" TabIndex="20"
                                Width="280px" Style="text-align: left;" AutoPostBack="false" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <%--<fieldset style="border-top: 1px dotted rgb(131, 127, 130); border-radius: 3px; width: 90%;
