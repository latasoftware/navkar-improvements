...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function SB() {
            ...
            window.open('../Report/rptSugarPurchaseReturnForGST.aspx?billno=' + billno)
        }</script>
                ...
                <table width="80%" align="left">
                    <tr>
                        ...
                        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btnHelp" Width="90px"
                            TabIndex="33" Height="24px" ValidationGroup="add" OnClick="btnSave_Click" />
                            &nbsp;
                        ...
                        <td style="width: 100%;" align="left">
                            <table width="100%" cellspacing="4" cellpadding="3">
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtSUBTOTAL" runat="Server" CssClass="txt" ReadOnly="true" Width="140px"
                                            ...
                                            Height="24px" TabIndex="24"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td style="">
                                        <asp:TextBox ID="txtCGSTRate" runat="Server" CssClass="txt" Width="52px" TabIndex="25"
                                ...
                                <tr>
                                    ...
                                    <td style="">
                                        <asp:TextBox ID="txtSGSTRate" runat="Server" CssClass="txt" Width="50px" TabIndex="26"
                                ...
                                <tr>
                                    ...
                                    <td style="">
                                        <asp:TextBox ID="txtIGSTRate" runat="Server" CssClass="txt" Width="52px" AutoPostBack="true"
                                            OnTextChanged="txtLIGST_TextChanged" TabIndex="27" Style="text-align: right;"
                                            Height="24px"></asp:TextBox>
