...
public partial class pgeOther_Purchase : System.Web.UI.Page
{
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        int maxno = Convert.ToInt32(clsCommon.getString("select ifnull(max(opid),0) as opid from nt_1_other_purchase "));
    ...
    private void csCalculations()
    {
        try
        {
            ...
            if (txtDoc_No.Text.Trim() != string.Empty)
            {
                ...
                if (a == true)
                {
                    aaa = clsCommon.getString("select IFNULL(GSTStateCode,0) from " + AccountMasterTable + " where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Ac_Code=" + txtDoc_No.Text + "");
                }
            }
            ...
            double taxamt = Convert.ToDouble(txtTaxable_Amount.Text);
