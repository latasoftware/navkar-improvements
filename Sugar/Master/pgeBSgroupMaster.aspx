                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtgroupName" runat="Server" CssClass="txt" TabIndex="2" Width="250px"
                                ...
                                Height="24px"></asp:TextBox>
                            <ajax1:FilteredTextBoxExtender ID="filtertxtgroupName" runat="server" FilterType="Custom,LowercaseLetters,UppercaseLetters"
                                ValidChars="() " TargetControlID="txtgroupName">
