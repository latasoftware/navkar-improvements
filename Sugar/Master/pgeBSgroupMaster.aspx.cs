            ...
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        lblbsid.Text = dt.Rows[0]["group_Code"].ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                flag = 2;
                qry = "update " + tblHead + " set " + Head_Update + " where Company_Code='" + Company_Code + "' and Group_Code='" + txtgroupCode.Text + "'";
        ...
        try
        {
            if (hdconfirm.Value == "Yes")
            {
                ...
                if (str == string.Empty)   //Gledger does not contain this account then delete
                {
                    ...
                    if (msg == "Delete")
                    {
                        Response.Redirect("../Master/pgeGroup_Master.aspx");
                    }
