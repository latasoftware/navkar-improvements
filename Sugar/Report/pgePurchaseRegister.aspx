<%@ Page Title="Purchase Register" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgePurchaseRegister.aspx.cs" Inherits="Report_pgePurchaseRegister" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajax1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function pr(fromdt, todt) {
            window.open('rptPurchaseRegister.aspx?fromdt=' + fromdt + '&todt=' + todt);    //R=Redirected  O=Original
        }

        function sr(fromdt, todt) {
            //window.open('rptDateWiseSaleRegister.aspx?AcCode=' + Ac_Code + '&FromDt=' + FromDt + '&ToDt=' + ToDt);
            window.open('rptSaleRegisterDateWise.aspx?fromdt=' + fromdt + '&todt=' + todt);
        }
