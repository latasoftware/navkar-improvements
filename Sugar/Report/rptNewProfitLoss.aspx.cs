...
public partial class Report_rptNewProfitLoss : System.Web.UI.Page
{
    ...
    protected void DataList1_ItemDataBound(object sender, DataListItemEventArgs e)
    {
       ...
       // Label lblQntlGrandTotal = (Label)e.Item.FindControl("lblQntaltotal");
        ...
        string qry = "select distinct dono,  dodate,doqntl,billno, billdate,billto,billtoname,IfNULL(saleqty,0) as saleqty ,IfNULL(salerate,0) as salerate,ifnull( profit,0) as profit  from qrytenderprofit where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString())
