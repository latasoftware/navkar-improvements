...
public partial class Report_rptDoWiseDispatch : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        try
        {
            ...
            qry = "select doc_no ,doc_dateConverted as dodate,millShortName as millShortName,voucherbyshortname as VocBy,getpassshortname as GetPass,driver_no,SB_No,IFNULL(SaleBillTo,0) as SaleBillTo" +
                    ...
                    " where company_code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + " and doc_date between '" + fromDT + "' and '" + toDT + "' and  tran_type='DO' order by doc_no asc";
