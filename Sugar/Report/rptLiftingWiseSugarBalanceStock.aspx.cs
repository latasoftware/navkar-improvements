    ...
    private void Bindata()
    {
        try
        {
            ...
            string qry = "select distinct Tender_No,Tender_DateConverted as  Tender_Date,"
               ...
               + " from qrytenderdobalanceview  where BALANCE!=0 and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + " order by Lifting_Date asc";
            //ds = obj.GetDataSet(qry);
            ds = clsDAL.SimpleQuery(qry);
            string qry1 = "select ID as ID, buyername as buyerbrokerfullname,Sale_Rate,Buyer_Quantal,DESPATCH as despatchqty,BALANCE as balance,Tender_No from qrytenderdobalanceview where"
