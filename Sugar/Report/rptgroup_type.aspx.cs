...
public partial class Sugar_Report_rptgroup_type : System.Web.UI.Page
{
    ...
    private DataTable GetData(string type, int company_Code)
    {
        ...
        using (MySqlConnection con = new MySqlConnection(strcon))
        {
            if (type != "")
            {
                MySqlCommand cmd = new MySqlCommand("select * from qrymstaccountmaster where group_Code='" + type + "' and Company_Code='" + company_code + "'", con);
            ...
            {
                MySqlCommand cmd = new MySqlCommand("select * from qrymstaccountmaster where  Company_Code='" + company_code + "'", con);
                cmd.CommandType = CommandType.Text;
                MySqlDataAdapter sda = new MySqlDataAdapter(cmd);
                sda.Fill(dt);
            }
