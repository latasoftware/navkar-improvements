        ...
        <table width="100%" align="left" cellspacing="5">
            <tr>
                ...
                <td align="left" colspan="5" style="width: 60%;">
                    <asp:DropDownList runat="server" ID="drpType" CssClass="ddl" Width="150px" TabIndex="1"
            ...
            <tr>
                ...
                <td align="left" colspan="5" style="width: 60%;">
                    <asp:TextBox ID="txtAcCode" runat="server" Width="80px" CssClass="txt" AutoPostBack="True"
                        OnTextChanged="txtAcCode_TextChanged" onkeyDown="ac_name(event);" Height="24px" TabIndex="2"></asp:TextBox>
            ...
            <tr>
                <td align="left" style="width: 40%;">
                    <asp:Button ID="btnDetailRptNew" runat="server" Text="UTR Report Summary" CssClass="btnHelp"
                        Width="150px" Height="24px" TabIndex="6" OnClick="btnDetailRptNew_Click" />
                </td>
                <td align="Right">
                    <asp:Button ID="btnUTRNODOWise" runat="server" Text="UTR Detail Report New" CssClass="btnHelp"
                        Width="150px" Height="24px" TabIndex="6" OnClick="btnUTRNODOWise_Click" />
                </td>
            </tr>
        </table>
        <table>
            ...
            <tr>
                <td align="left" style="width: 40%;">
                    <asp:Button ID="btnMillPaySummary" runat="server" Text="Mill Payment Summary" CssClass="btnHelp"
                        Width="150px" Height="24px" TabIndex="6" OnClick="btnMillPaySummary_Click" />
                </td>
                <td align="Right">
                    <asp:Button ID="btnMillPayDetail" runat="server" Text="Mill Payment Detail" CssClass="btnHelp"
                        Width="150px" Height="24px" TabIndex="6" OnClick="btnMillPayDetail_Click" />
                </td>
            </tr>
        </table>
    </center>
