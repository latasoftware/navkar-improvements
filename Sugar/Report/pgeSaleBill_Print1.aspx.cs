...
public partial class Sugar_Report_pgeSaleBill_Print1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            rpt.Load(Server.MapPath("crySaleBill_Print1.rpt"));
    ...
    private DataTable GetData()
    {
        try
        {
            ...
            {
                MySqlCommand cmd = new MySqlCommand("select * from qrysaleheaddetail where  saleid in(" + doc_no + ")", con);
            ...
            {
                DataSet dsbillto = clsDAL.SimpleQuery("select Ac_Code,Ac_Name_E,Address_E,cityname,citystate,ifnull(citygststatecode,0) as citygststatecode " +
