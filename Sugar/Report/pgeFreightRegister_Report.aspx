<%@ Page Title="freightRegister Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgeFreightRegister_Report.aspx.cs" Inherits="Report_pgeFreightRegister_Report_Report" %>
    ...
    <center>
        ...
        <table>
            <tr>
                ...
                <td align="right">
                    <asp:Button ID="btnUTRNODOWise" runat="server" Text="FreightDetail Balance Report " CssClass="btnHelp"
                        Width="210px" Height="24px" TabIndex="7" OnClick="btnUTRNODOWise_Click" />
                </td>
            </tr>
        </table>
        <table>
