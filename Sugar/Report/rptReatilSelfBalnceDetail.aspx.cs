...
public partial class Sugar_Report_rptReatilSelfBalnceDetail : System.Web.UI.Page
{
    ...
    private DataTable GetData(string from, string to)
    {
        ...
        using (MySqlConnection con = new MySqlConnection(strcon))
        {
            ...
            {
                MySqlCommand cmd = new MySqlCommand("select * from qryretailseflbalncedetail where  doc_date between '" + from +
            ...
            {
                MySqlCommand cmd = new MySqlCommand("select * from qryretailseflbalncedetail where  doc_date between '" + FromDt +
