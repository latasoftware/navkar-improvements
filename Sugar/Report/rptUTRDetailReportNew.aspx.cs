...
public partial class Report_rptUTRDetailReportNew : System.Web.UI.Page
{
    ...
    private DataTable GetData(string from, string to)
    {
        ...
        using (MySqlConnection con = new MySqlConnection(strcon))
        {
            ...
            if (utr_no != "0")
            {
                MySqlCommand cmd = new MySqlCommand("select * from qryutrdobalance where  doc_date between '" + FromDt +
            ...
            {
                MySqlCommand cmd = new MySqlCommand("select * from qryutrdobalance where  doc_date between '" + from +
