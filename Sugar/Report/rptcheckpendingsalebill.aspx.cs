    ...
    private void bindData()
    {
        try
        {
            ...
            DataTable dt = new DataTable();
                ...
                string qry = "";
                qry = "SELECT doc_no as DO_NO,doc_dateConverted as doc_Date,quantal,salebillname FROM qrydohead where  SB_NO is null and desp_type!='DO' and SaleBillTo!=0 and Company_Code="
