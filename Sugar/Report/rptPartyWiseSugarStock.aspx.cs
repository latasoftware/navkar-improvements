...
public partial class Report_rptPartyWiseSugarStock : System.Web.UI.Page
{
    ...
    private void BindList()
    {
        try
        {
            ...
            qry = "select  Tender_No,tenderid,millshortname,Grade,Mill_Rate,Sale_Rate,Lifting_DateConverted as Tender_Date,Buyer_Quantal," +
             "DESPATCH,BALANCE,tenderdoshortname,Buyer from " +
