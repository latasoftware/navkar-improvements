        ...
        <tr>
            <td>
                ...
                <asp:Button ID="btnTenderPSBrokerReport" runat="server" Text="Purcahse Broker Report"
                    CssClass="btnHelp" Width="150px" Height="24px" TabIndex="6" OnClick="btnTenderPSBrokerReport_Click" />
                ...
                &nbsp;&nbsp;&nbsp;<asp:Button ID="btnDetailSellBrokerReport" runat="server" Text="Retail Sell broker Report"
                    CssClass="btnHelp" Width="180px" Height="24px" TabIndex="6" OnClick="btnDetailSellBrokerReport_Click" />
                &nbsp;&nbsp;&nbsp;<asp:Button ID="btnTenderDOReport" runat="server" Text="Tender DO Report"
                    CssClass="btnHelp" Width="180px" Height="24px" TabIndex="6" OnClick="btnTenderDOReport_Click" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:Button runat="server" ID="btnAllBrokerDetail" CssClass="btnHelp" OnCommand="Command_Click"
                    Height="24px" CommandName="ABD" Text="All Broker Detail" Visible="false" Width="185px" />&nbsp;&nbsp;&nbsp;<asp:Button
                        runat="server" ID="btnBrokerWiseShortPayAll" CssClass="btnHelp" Visible="false" Text="Broker Wise ShortPay All"
