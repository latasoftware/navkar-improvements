...
public partial class Reports_rptSugarBalanceStocks : System.Web.UI.Page
{
    ...
    private void Bindata()
    {
        try
        {
            ...
            string qry = "select distinct Tender_No,Tender_DateConverted as Tender_Date,millshortname as millname,Grade,Quantal as Quantal,Mill_Rate as Mill_Rate ,Purc_Rate as Purc_Rate,Lifting_DateConverted as Lifting_Date,tenderdoshortname as doname  " +
