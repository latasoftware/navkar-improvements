...
public partial class Sugar_Report_rptFreightRegister_DateWise : System.Web.UI.Page
{
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (MySqlConnection con = new MySqlConnection(strcon))
        {
            ...
            MySqlCommand cmd = new MySqlCommand("select * from qrydohead where Ac_Code = " + Accode + " and  doc_date between '" + datefrom + "' and '" + dateto + "'and company_code = " + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code = " + Convert.ToInt32(Session["year"].ToString()) + "", con);
