...
public partial class Report_rptVasuliRegister : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            qry = "select distinct transport,transportname from qrydohead where  company_code=" + Convert.ToInt32(Session["Company_Code"]) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + " and doc_date between '" + fromDate + "' and '" + toDate + "' order by transportname asc";
            ...
            qry = "Select doc_no, doc_dateConverted as doc_date ,millShortName,quantal,salebillname,truck_no,vasuli_amount1,transport from qrydohead " +
                   " where company_code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + "   and doc_date between '" + fromDate + "' and '" + toDate + "'";
