...
public partial class Report_rptTenderPurchaseBrokerDetailReport : System.Web.UI.Page
{
    ...
    private DataTable GetData(string from, string to)
    {
        ...
        using (MySqlConnection con = new MySqlConnection(strcon))
        {
            if (ac_code != "0")
            {
                MySqlCommand cmd = new MySqlCommand("select * from qrytenderheaddetail where   Buyer_Party='" + ac_code + "' and Tender_Date between '" + datefrom.ToString() +
            ...
            {
                MySqlCommand cmd = new MySqlCommand("select * from qrytenderheaddetail where  Buyer_Party!='2' and Tender_Date between '" + datefrom.ToString() +
                    "' and '" + dateto.ToString() + "'", con);
                cmd.CommandType = CommandType.Text;
                MySqlDataAdapter sda = new MySqlDataAdapter(cmd);
                sda.Fill(dt);
