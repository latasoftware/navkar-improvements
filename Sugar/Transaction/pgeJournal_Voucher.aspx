...
function SelectRow(CurrentRow, RowIndex) {
    ...
    <script type="text/javascript">
        ...
        function Narration(e) {
            ...
            if (e.keyCode == 9) {
                e.preventDefault();
                var unit = $("#<%=txtnarration.ClientID %>").val();

                unit = unit;
                $("#<%=txtnarration.ClientID %>").val(unit);
                __doPostBack("txtnarration", "TextChanged");
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table width="90%" align="left" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <tr>
                            <td align="left" colspan="2" style="width: 10%;">Entry No: &nbsp;&nbsp;
                            ...
                            <td align="left" colspan="2" style="width: 10%;">Date: &nbsp;&nbsp;
