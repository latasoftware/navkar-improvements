        ...
        <ContentTemplate>
            ...
            <div style="width: 100%; position: relative;">
                <asp:UpdatePanel ID="upGrid" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="pnlgrdDetail" runat="server" ScrollBars="Both" Height="300px" Width="1600px"
                                    ...
                                    <asp:TemplateField HeaderText="Amount">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtgrdAmount" CssClass="txt" AutoPostBack="true"
                                                onKeyDown="GrdAmount(event,this);" TabIndex="9" Width="80px" Height="24px" Style="text-align: right;" Text='<%#Eval("Amount") %>' OnTextChanged="txtgrdAmount_TextChanged"></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="Adjusted_Amount">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtgrdAdjustedAmount" CssClass="txt" AutoPostBack="true"
                                                onKeyDown="GrdAdjAmount(event,this);" TabIndex="10" Width="80px" Height="24px" Style="text-align: right;" Text='<%#Eval("Adjusted_Amount") %>' OnTextChanged="txtgrdAdjustedAmount_TextChanged"> </asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="Narration">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtNarration" CssClass="txt" AutoPostBack="true"
                                                onKeyDown="Narration(event,this);" TabIndex="11" Width="80px" Height="24px" Style="text-align: right;" Text='<%#Eval("Narration") %>' OnTextChanged="txtNarration_TextChanged"> </asp:TextBox>
                                        </ItemTemplate>
                                        <ItemStyle Width="200px" HorizontalAlign="Right" />
                                    </asp:TemplateField>
                ...
                <tr>
                    <td align="right">
                        <asp:Label ID="lblTotal" runat="server" CssClass="lblName" Font-Bold="true" Text="Total:"></asp:Label>&nbsp;<asp:TextBox
                            TabIndex="10" ID="txtTotal" runat="server" ReadOnly="true" CssClass="txt" Width="100px" Style="text-align: right;"></asp:TextBox>
                    </td>
                </tr>
            </table>
            <br />
