...
public partial class Sugar_Master_PgeDebitCreditNoteUtility : System.Web.UI.Page
{
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, string Trantype, int PageSize, int Company_Code, int year)
    {
        ...
        foreach (var s in split)
        {
            ...
            name += "( Ac_Name_E like '%" + aa + "%' or doc_no like '%" + aa + "%' or tran_type like '%" + aa + "%' or doc_dateConverted like '%" + aa + "%' or bill_amount like '%" + aa + "%' or dcid like '%" + aa + "%') and";
     ...
     + "doc_dateConverted as doc_date ,Ac_Name_E,bill_amount,dcid FROM qrydebitnotehead    where " + name + " and tran_type='" + Trantype + "' and Company_Code=" + Company_Code + " " +
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
     ...
     + "doc_dateConverted as doc_date ,Ac_Name_E,bill_amount,dcid FROM " + qryCommon + " limit 15";
