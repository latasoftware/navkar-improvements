...
public partial class Sugar_Transaction_pgeUtr_Data : System.Web.UI.Page
{
    ...
    public string getData()
    {
        ...
        try
        {
            ...
            DataSet ds = clsDAL.SimpleQuery("select doc_no,Mill_Code,utr_no,ifnull(lot_no,0) as Lott_No,utrid  from qryutrheaddetail where Company_code=" + Session["Company_Code"].ToString() + " " +
